          ...
          ({
            ...
            >
              <div
                ...
                before:w-[1px] before:bg-tertiary"
              />

              <div
                className="flex w-4/5 flex-col justify-center rounded-xl bg-primary/20 dark:bg-secondary/20
              ...
              >
                ...
                {today.isAfter(formattedDate(finalDate)) ? (
                  <p className="absolute top-3 right-12 rounded-xl bg-primary/60 dark:bg-secondary/60 py-1 px-3 text-xs lg:right-3">
                    Concluído!
                  </p>
                ) : (
                  <p className="absolute top-3 right-12 rounded-xl bg-primary/60 dark:bg-secondary/60 py-1 px-3 text-xs lg:right-3">
                ...
                <h4 className="text-sm font-medium text-tertiary dark:text-highlight">
                  {course}
                </h4>
